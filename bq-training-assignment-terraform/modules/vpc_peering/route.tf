resource "aws_route" "route_to_vpc_accepter_private" {
  route_table_id            = var.vpc_requester_pri_route_table_id  # Specify route table ID of VPC1
...
resource "aws_route" "route_to_vpc_requester_private" {
  ...
  route_table_id            = var.vpc_accepter_pri_route_table_id   # Specify route table ID of VPC2
